{
  '#': { help: 'backstageEntities.api', name: 'api' },
  ...
  '#withKind': { 'function': { args: [{ default: 'API', enums: ['API'], name: 'value', type: ['string'] }], help: 'The high level entity type being described.' } },
  withKind(value='API'): { kind: value },
  ...
  '#withDefinition': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'The definition of the API, based on the format defined by the type.' } },
  withDefinition(value): { spec+: { definition: value } },
  '#withLifecycle': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'The lifecycle state of the API.' } },
  withLifecycle(value): { spec+: { lifecycle: value } },
  '#withOwner': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'An entity reference to the owner of the API.' } },
  withOwner(value): { spec+: { owner: value } },
  '#withSystem': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'An entity reference to the system that the API belongs to.' } },
  withSystem(value): { spec+: { system: value } },
  '#withType': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'The type of the API definition.' } },
