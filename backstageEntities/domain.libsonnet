{
  '#': { help: 'backstageEntities.domain', name: 'domain' },
  ...
  '#withKind': { 'function': { args: [{ default: 'Domain', enums: ['Domain'], name: 'value', type: ['string'] }], help: 'The high level entity type being described.' } },
  withKind(value='Domain'): { kind: value },
