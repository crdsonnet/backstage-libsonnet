{
  '#': { help: 'backstageEntities.component', name: 'component' },
  ...
  '#withKind': { 'function': { args: [{ default: 'Component', enums: ['Component'], name: 'value', type: ['string'] }], help: 'The high level entity type being described.' } },
  withKind(value='Component'): { kind: value },
  ...
  '#withConsumesApis': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'An array of entity references to the APIs that are consumed by the component.' } },
  withConsumesApis(value): { spec+: { consumesApis: (if std.isArray(value)
                                                     then value
                                                     else [value]) } },
  '#withConsumesApisMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'An array of entity references to the APIs that are consumed by the component.' } },
  withConsumesApisMixin(value): { spec+: { consumesApis+: (if std.isArray(value)
                                                           then value
                                                           else [value]) } },
  '#withDependsOn': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'An array of references to other entities that the component depends on to function.' } },
  withDependsOn(value): { spec+: { dependsOn: (if std.isArray(value)
                                               then value
                                               else [value]) } },
  '#withDependsOnMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'An array of references to other entities that the component depends on to function.' } },
  withDependsOnMixin(value): { spec+: { dependsOn+: (if std.isArray(value)
                                                     then value
                                                     else [value]) } },
  '#withLifecycle': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'The lifecycle state of the component.' } },
  withLifecycle(value): { spec+: { lifecycle: value } },
  ...
  '#withProvidesApis': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'An array of entity references to the APIs that are provided by the component.' } },
  withProvidesApis(value): { spec+: { providesApis: (if std.isArray(value)
                                                     then value
                                                     else [value]) } },
  '#withProvidesApisMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'An array of entity references to the APIs that are provided by the component.' } },
  withProvidesApisMixin(value): { spec+: { providesApis+: (if std.isArray(value)
                                                           then value
                                                           else [value]) } },
  '#withSubcomponentOf': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'An entity reference to another component of which the component is a part.' } },
  withSubcomponentOf(value): { spec+: { subcomponentOf: value } },
  '#withSystem': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'An entity reference to the system that the component belongs to.' } },
  withSystem(value): { spec+: { system: value } },
  '#withType': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'The type of component.' } },
