{
  '#': { help: 'backstageEntities.resource', name: 'resource' },
  ...
  '#withKind': { 'function': { args: [{ default: 'Resource', enums: ['Resource'], name: 'value', type: ['string'] }], help: 'The high level entity type being described.' } },
  withKind(value='Resource'): { kind: value },
  ...
  '#withDependsOn': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'An array of references to other entities that the resource depends on to function.' } },
  withDependsOn(value): { spec+: { dependsOn: (if std.isArray(value)
                                               then value
                                               else [value]) } },
  '#withDependsOnMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'An array of references to other entities that the resource depends on to function.' } },
  withDependsOnMixin(value): { spec+: { dependsOn+: (if std.isArray(value)
                                                     then value
                                                     else [value]) } },
  '#withOwner': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'An entity reference to the owner of the resource.' } },
  withOwner(value): { spec+: { owner: value } },
  '#withSystem': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'An entity reference to the system that the resource belongs to.' } },
  withSystem(value): { spec+: { system: value } },
  '#withType': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'The type of resource.' } },
