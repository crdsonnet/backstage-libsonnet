{
  '#': { help: 'backstageEntities.user', name: 'user' },
  ...
  '#withKind': { 'function': { args: [{ default: 'User', enums: ['User'], name: 'value', type: ['string'] }], help: 'The high level entity type being described.' } },
  withKind(value='User'): { kind: value },
  ...
  '#withMemberOf': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'The list of groups that the user is a direct member of (i.e., no transitive memberships are listed here). The list must be present, but may be empty if the user is not member of any groups. The items are not guaranteed to be ordered in any particular way. The entries of this array are entity references.' } },
  withMemberOf(value): { spec+: { memberOf: (if std.isArray(value)
                                             then value
                                             else [value]) } },
  '#withMemberOfMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'The list of groups that the user is a direct member of (i.e., no transitive memberships are listed here). The list must be present, but may be empty if the user is not member of any groups. The items are not guaranteed to be ordered in any particular way. The entries of this array are entity references.' } },
  withMemberOfMixin(value): { spec+: { memberOf+: (if std.isArray(value)
                                                   then value
                                                   else [value]) } },
  '#withProfile': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: "Optional profile information about the user, mainly for display purposes. All fields of this structure are also optional. The email would be a primary email of some form, that the user may wish to be used for contacting them. The picture is expected to be a URL pointing to an image that's representative of the user, and that a browser could fetch and render on a profile page or similar." } },
  withProfile(value): { spec+: { profile: value } },
  '#withProfileMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: "Optional profile information about the user, mainly for display purposes. All fields of this structure are also optional. The email would be a primary email of some form, that the user may wish to be used for contacting them. The picture is expected to be a URL pointing to an image that's representative of the user, and that a browser could fetch and render on a profile page or similar." } },
  ...
  profile+:
    {
      ...
      '#withEmail': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'An email where this user can be reached.' } },
      withEmail(value): { spec+: { profile+: { email: value } } },
      '#withPicture': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'The URL of an image that represents this user.' } },
