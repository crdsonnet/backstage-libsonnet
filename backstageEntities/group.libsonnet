{
  '#': { help: 'backstageEntities.group', name: 'group' },
  ...
  '#withKind': { 'function': { args: [{ default: 'Group', enums: ['Group'], name: 'value', type: ['string'] }], help: 'The high level entity type being described.' } },
  withKind(value='Group'): { kind: value },
  ...
  '#withChildren': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'The immediate child groups of this group in the hierarchy (whose parent field points to this group). The list must be present, but may be empty if there are no child groups. The items are not guaranteed to be ordered in any particular way. The entries of this array are entity references.' } },
  withChildren(value): { spec+: { children: (if std.isArray(value)
                                             then value
                                             else [value]) } },
  '#withChildrenMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'The immediate child groups of this group in the hierarchy (whose parent field points to this group). The list must be present, but may be empty if there are no child groups. The items are not guaranteed to be ordered in any particular way. The entries of this array are entity references.' } },
  withChildrenMixin(value): { spec+: { children+: (if std.isArray(value)
                                                   then value
                                                   else [value]) } },
  '#withMembers': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'The users that are members of this group. The entries of this array are entity references.' } },
  withMembers(value): { spec+: { members: (if std.isArray(value)
                                           then value
                                           else [value]) } },
  '#withMembersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'The users that are members of this group. The entries of this array are entity references.' } },
  withMembersMixin(value): { spec+: { members+: (if std.isArray(value)
                                                 then value
                                                 else [value]) } },
  '#withParent': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'The immediate parent group in the hierarchy, if any. Not all groups must have a parent; the catalog supports multi-root hierarchies. Groups may however not have more than one parent. This field is an entity reference.' } },
  withParent(value): { spec+: { parent: value } },
  '#withProfile': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: "Optional profile information about the group, mainly for display purposes. All fields of this structure are also optional. The email would be a group email of some form, that the group may wish to be used for contacting them. The picture is expected to be a URL pointing to an image that's representative of the group, and that a browser could fetch and render on a group page or similar." } },
  withProfile(value): { spec+: { profile: value } },
  '#withProfileMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: "Optional profile information about the group, mainly for display purposes. All fields of this structure are also optional. The email would be a group email of some form, that the group may wish to be used for contacting them. The picture is expected to be a URL pointing to an image that's representative of the group, and that a browser could fetch and render on a group page or similar." } },
  withProfileMixin(value): { spec+: { profile+: value } },
  profile+:
    {
      '#withDisplayName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'A simple display name to present to users.' } },
      withDisplayName(value): { spec+: { profile+: { displayName: value } } },
      '#withEmail': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'An email where this entity can be reached.' } },
      withEmail(value): { spec+: { profile+: { email: value } } },
      '#withPicture': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'The URL of an image that represents this entity.' } },
      withPicture(value): { spec+: { profile+: { picture: value } } },
    },
  '#withType': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'The type of group. There is currently no enforced set of values for this field, so it is left up to the adopting organization to choose a nomenclature that matches their org hierarchy.' } },
